...
public class Search {
	...
	@When("User enters valid {string} into Search box fields")
	public void user_enters_valid_into_search_box_fields(String validProductText) {
		homePage = new HomePage(driver);
		homePage.EnterSearchField(validProductText);
	...
	public void user_should_get_valid_product_displayed_in_search_results() {
		Assert.assertTrue(searchResultPage.GetvalidSearchElement());
	}

	@When("User enters invalid product {string} into Search box field")
	public void user_enters_invalid_product_into_search_box_field(String invalidProductText) {
		homePage = new HomePage(driver);
		homePage.EnterSearchField(invalidProductText);
	}
